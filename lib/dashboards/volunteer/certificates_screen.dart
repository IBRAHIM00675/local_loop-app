        ...
        build: (context) => pw.Center(
          child: pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                pw.Text('Certificate of Appreciation',
                    style: pw.TextStyle(fontSize: 32, fontWeight: pw.FontWeight.bold)),
                pw.SizedBox(height: 20),
                pw.Text('Awarded to', style: pw.TextStyle(fontSize: 20)),
                pw.SizedBox(height: 10),
                pw.Text(name, style: pw.TextStyle(fontSize: 28, fontWeight: pw.FontWeight.bold)),
                pw.SizedBox(height: 20),
                pw.Text('For contributing $hours volunteer hour${hours > 1 ? 's' : ''} to the community.',
